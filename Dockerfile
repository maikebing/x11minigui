...
RUN dpkg --add-architecture i386 && \
    ...
    apt-get install -y --no-install-recommends \
        ...
        libjpeg-dev:i386 libpng-dev:i386 libfreetype6-dev:i386 \
        libinput-dev libdrm-dev libsqlite3-dev libxml2-dev libssl-dev libconfig-dev libpq-dev \
        libsqlite3-dev:i386 libxml2-dev:i386 libssl-dev:i386 \
...
RUN cd ~/ && \
    ...
    cd ~/ && rm -rf ~/curl-7.67.0/ ~/curl-7.67.0.tar.gz
